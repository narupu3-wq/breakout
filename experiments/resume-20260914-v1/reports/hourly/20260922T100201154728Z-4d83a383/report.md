...
取得UTC: 2026-09-22T10:02:01.154728+00:00
状態: attention_required
実発注0。公開代理価格による仮想結果。候補は別口座で合算しない。

観測時間: 191.97 h / heartbeat経過秒: 45.935046911239624
直近1時間は取得時刻からの半開区間 (開始, 終了]。
イベント累積: {"daily_reset": 72, "decision": 1380, "no_signal": 10924, "heartbeat": 11139, "intent": 342, "paper_fill": 342, "close": 341, "collection_error": 3, "risk_budget_exhausted": 3}
イベント直近1h: {"heartbeat": 58, "no_signal": 52, "decision": 12}
...
|mean_reversion-moderate|0|0.0000|52|-50.7680|-1.0277|55.5158|
...
- mean_reversion-moderate: BTCUSD side=-1, quote=fresh, quote_ts=1790071274.501009
...
|---|---|---|
|観測間隔|11138 / 62.05 / 63.86 / 131.53|58 / 61.82 / 62.33 / 63.20|
|設定待機時間を超える分|11138 / 2.05 / 3.86 / 71.53|58 / 1.82 / 2.33 / 3.20|
|足確定→条件確認|1538 / 32.95 / 61.01 / 194.24|8 / 34.80 / 54.99 / 54.99|
|足確定→シグナル判断|272 / 33.93 / 61.66 / 194.24|3 / 25.55 / 49.17 / 49.17|
