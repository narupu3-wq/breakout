...
取得UTC: 2026-09-14T10:03:28.855315+00:00
状態: observing
実発注0。公開代理価格による仮想結果。候補は別口座で合算しない。

観測時間: 0.00 h / heartbeat経過秒: 14.61356806755066
直近1時間は取得時刻からの半開区間 (開始, 終了]。
イベント累積: {"daily_reset": 8, "decision": 8, "no_signal": 8, "heartbeat": 1}
イベント直近1h: {"daily_reset": 8, "decision": 8, "no_signal": 8, "heartbeat": 1}

| 候補 | 1h決済 | 1h確定USD | 累積決済 | 累積確定USD | 含みUSD | 最大DD USD |
|---|---:|---:|---:|---:|---:|---:|
|mean_reversion-cautious|0|0.0000|0|0.0000|0.0000|0.0000|
|mean_reversion-cautious-stress|0|0.0000|0|0.0000|0.0000|0.0000|
|mean_reversion-moderate|0|0.0000|0|0.0000|0.0000|0.0000|
|mean_reversion-moderate-stress|0|0.0000|0|0.0000|0.0000|0.0000|
|trend-cautious|0|0.0000|0|0.0000|0.0000|0.0000|
|trend-cautious-stress|0|0.0000|0|0.0000|0.0000|0.0000|
|trend-moderate|0|0.0000|0|0.0000|0.0000|0.0000|
|trend-moderate-stress|0|0.0000|0|0.0000|0.0000|0.0000|
...
|---|---|---|
|観測間隔|0 / 未計測 / 未計測 / 未計測|0 / 未計測 / 未計測 / 未計測|
|設定待機時間を超える分|0 / 未計測 / 未計測 / 未計測|0 / 未計測 / 未計測 / 未計測|
|足確定→条件確認|2 / 194.24 / 194.24 / 194.24|2 / 194.24 / 194.24 / 194.24|
|足確定→シグナル判断|1 / 194.24 / 194.24 / 194.24|1 / 194.24 / 194.24 / 194.24|
- total: 収集エラー 0件、エラーを挟む観測間隔 0件、150.0秒超の間隔 0件、鮮度期限超のシグナル観測 1件、不正な判断イベント 0件。
- last_1h: 収集エラー 0件、エラーを挟む観測間隔 0件、150.0秒超の間隔 0件、鮮度期限超のシグナル観測 1件、不正な判断イベント 0件。
