...
取得UTC: 2026-09-08T17:50:51.650542+00:00
状態: attention_required
実発注0。公開代理価格による仮想結果。候補は別口座で合算しない。

観測時間: 40.57 h / heartbeat経過秒: 10.54923415184021
直近1時間は取得時刻からの半開区間 (開始, 終了]。
イベント累積: {"daily_reset": 16, "no_signal": 2364, "heartbeat": 2364, "decision": 244, "intent": 72, "paper_fill": 72, "close": 68, "collection_error": 2}
イベント直近1h: {"heartbeat": 59, "no_signal": 64}

| 候補 | 1h決済 | 1h確定USD | 累積決済 | 累積確定USD | 含みUSD | 最大DD USD |
|---|---:|---:|---:|---:|---:|---:|
|mean_reversion-cautious|0|0.0000|11|4.2205|0.5036|7.3058|
|mean_reversion-cautious-stress|0|0.0000|11|-3.6679|0.3094|10.0661|
|mean_reversion-moderate|0|0.0000|11|4.2205|0.5036|7.3058|
|mean_reversion-moderate-stress|0|0.0000|11|-3.6679|0.3094|10.0661|
...
- mean_reversion-cautious: ETHUSD side=-1, quote=fresh, quote_ts=1788889841.1013079
- mean_reversion-cautious-stress: ETHUSD side=-1, quote=fresh, quote_ts=1788889841.1013079
- mean_reversion-moderate: ETHUSD side=-1, quote=fresh, quote_ts=1788889841.1013079
- mean_reversion-moderate-stress: ETHUSD side=-1, quote=fresh, quote_ts=1788889841.1013079
...
|---|---|---|
|観測間隔|2363 / 61.81 / 62.39 / 123.32|59 / 61.76 / 62.25 / 62.31|
|設定待機時間を超える分|2363 / 1.81 / 2.39 / 63.32|59 / 1.76 / 2.25 / 2.31|
|足確定→条件確認|326 / 33.91 / 61.79 / 78.87|8 / 23.75 / 41.33 / 41.33|
