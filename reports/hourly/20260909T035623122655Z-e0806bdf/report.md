...
取得UTC: 2026-09-09T03:56:23.122655+00:00
状態: attention_required
実発注0。公開代理価格による仮想結果。候補は別口座で合算しない。

観測時間: 50.66 h / heartbeat経過秒: 33.11208701133728
直近1時間は取得時刻からの半開区間 (開始, 終了]。
イベント累積: {"daily_reset": 24, "no_signal": 2988, "heartbeat": 2953, "decision": 260, "intent": 76, "paper_fill": 76, "close": 72, "collection_error": 2}
イベント直近1h: {"heartbeat": 58, "no_signal": 64}

| 候補 | 1h決済 | 1h確定USD | 累積決済 | 累積確定USD | 含みUSD | 最大DD USD |
|---|---:|---:|---:|---:|---:|---:|
|mean_reversion-cautious|0|0.0000|12|5.4050|0.9362|7.3058|
|mean_reversion-cautious-stress|0|0.0000|12|-3.1197|0.4480|10.0661|
|mean_reversion-moderate|0|0.0000|12|5.4050|0.9362|7.3058|
|mean_reversion-moderate-stress|0|0.0000|12|-3.1197|0.4480|10.0661|
...
- mean_reversion-cautious: BTCUSD side=-1, quote=fresh, quote_ts=1788926149.319437
- mean_reversion-cautious-stress: BTCUSD side=-1, quote=fresh, quote_ts=1788926149.319437
- mean_reversion-moderate: BTCUSD side=-1, quote=fresh, quote_ts=1788926149.319437
- mean_reversion-moderate-stress: BTCUSD side=-1, quote=fresh, quote_ts=1788926149.319437
...
|---|---|---|
|観測間隔|2952 / 61.78 / 62.34 / 123.32|58 / 61.63 / 62.15 / 63.91|
|設定待機時間を超える分|2952 / 1.78 / 2.34 / 63.32|58 / 1.63 / 2.15 / 3.91|
|足確定→条件確認|406 / 33.83 / 61.59 / 78.87|8 / 27.10 / 46.22 / 46.22|
|足確定→シグナル判断|48 / 32.48 / 57.76 / 59.51|0 / 未計測 / 未計測 / 未計測|
