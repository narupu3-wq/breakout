...
取得UTC: 2026-09-09T00:52:21.218659+00:00
状態: attention_required
実発注0。公開代理価格による仮想結果。候補は別口座で合算しない。

観測時間: 47.59 h / heartbeat経過秒: 23.348029375076294
直近1時間は取得時刻からの半開区間 (開始, 終了]。
イベント累積: {"daily_reset": 24, "no_signal": 2812, "heartbeat": 2774, "decision": 244, "intent": 72, "paper_fill": 72, "close": 72, "collection_error": 2}
イベント直近1h: {"heartbeat": 59, "no_signal": 64, "daily_reset": 8}
...
|---|---|---|
|観測間隔|2773 / 61.79 / 62.34 / 123.32|59 / 61.57 / 62.04 / 62.31|
|設定待機時間を超える分|2773 / 1.79 / 2.34 / 63.32|59 / 1.57 / 2.04 / 2.31|
|足確定→条件確認|382 / 33.93 / 61.79 / 78.87|8 / 43.10 / 61.83 / 61.83|
