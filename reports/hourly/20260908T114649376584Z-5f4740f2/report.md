...
取得UTC: 2026-09-08T11:46:49.376584+00:00
状態: attention_required
実発注0。公開代理価格による仮想結果。候補は別口座で合算しない。

観測時間: 34.50 h / heartbeat経過秒: 27.436981201171875
直近1時間は取得時刻からの半開区間 (開始, 終了]。
イベント累積: {"daily_reset": 16, "no_signal": 2020, "heartbeat": 2011, "decision": 204, "intent": 56, "paper_fill": 56, "close": 56, "collection_error": 2}
イベント直近1h: {"heartbeat": 58, "no_signal": 64}

| 候補 | 1h決済 | 1h確定USD | 累積決済 | 累積確定USD | 含みUSD | 最大DD USD |
|---|---:|---:|---:|---:|---:|---:|
|mean_reversion-cautious|0|0.0000|9|4.2311|0.0000|7.3058|
|mean_reversion-cautious-stress|0|0.0000|9|-2.5827|0.0000|8.8917|
|mean_reversion-moderate|0|0.0000|9|4.2311|0.0000|7.3058|
|mean_reversion-moderate-stress|0|0.0000|9|-2.5827|0.0000|8.8917|
...
|---|---|---|
|観測間隔|2010 / 61.79 / 62.28 / 123.32|58 / 61.61 / 61.96 / 62.23|
|設定待機時間を超える分|2010 / 1.79 / 2.28 / 63.32|58 / 1.61 / 1.96 / 2.23|
|足確定→条件確認|278 / 33.54 / 61.79 / 78.87|8 / 30.19 / 57.33 / 57.33|
...
{"status": "stored_reference_not_rechecked", "file": "/Users/ermagent/Home/BreakOut/reports/monitoring/sp500/20260908T104658174248Z.json", "record_age_seconds": 3591.2023360729218, "data": {"observed_at": 1788864418.174248, "instrument": "Breakout:S&P500", "cash_market_status": "outside_regular_session_before_2026-09-08_open", "reference_price": null, "reference_price_at": null, "change_percent": null, "breakout_bid": null, "breakout_ask": null, "status": "stored_calendar_price_unavailable", "next_regular_open": "2026-09-08T13:30:00Z", "sources": ["https://www.nyse.com/trade/hours-calendars"], "source_verified_at": "2026-09-08T04:46:04.253579+00:00", "note": "04:46 UTC確認済みNYSE通常時間を参照。NY現地9月8日06時台で現物指数通常時間外。今回外部再取得なし。指数値・Breakout直接気配未取得、新規価格サンプル0。"}}
