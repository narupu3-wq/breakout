...
取得UTC: 2026-09-08T15:49:47.553245+00:00
状態: attention_required
実発注0。公開代理価格による仮想結果。候補は別口座で合算しない。

観測時間: 38.54 h / heartbeat経過秒: 46.80018877983093
直近1時間は取得時刻からの半開区間 (開始, 終了]。
イベント累積: {"daily_reset": 16, "no_signal": 2244, "heartbeat": 2246, "decision": 236, "intent": 72, "paper_fill": 72, "close": 68, "collection_error": 2}
イベント直近1h: {"heartbeat": 58, "no_signal": 60, "decision": 4, "intent": 4, "paper_fill": 4}

| 候補 | 1h決済 | 1h確定USD | 累積決済 | 累積確定USD | 含みUSD | 最大DD USD |
|---|---:|---:|---:|---:|---:|---:|
|mean_reversion-cautious|0|0.0000|11|4.2205|-0.2379|7.3058|
|mean_reversion-cautious-stress|0|0.0000|11|-3.6679|-0.3424|10.0661|
|mean_reversion-moderate|0|0.0000|11|4.2205|-0.2379|7.3058|
|mean_reversion-moderate-stress|0|0.0000|11|-3.6679|-0.3424|10.0661|
...
- mean_reversion-cautious: ETHUSD side=-1, quote=fresh, quote_ts=1788882540.753056
- mean_reversion-cautious-stress: ETHUSD side=-1, quote=fresh, quote_ts=1788882540.753056
- mean_reversion-moderate: ETHUSD side=-1, quote=fresh, quote_ts=1788882540.753056
- mean_reversion-moderate-stress: ETHUSD side=-1, quote=fresh, quote_ts=1788882540.753056
...
|---|---|---|
|観測間隔|2245 / 61.81 / 62.38 / 123.32|58 / 61.94 / 62.61 / 62.96|
|設定待機時間を超える分|2245 / 1.81 / 2.38 / 63.32|58 / 1.94 / 2.61 / 2.96|
|足確定→条件確認|310 / 34.09 / 62.00 / 78.87|8 / 42.33 / 58.38 / 58.38|
|足確定→シグナル判断|42 / 32.76 / 56.80 / 59.51|1 / 54.39 / 54.39 / 54.39|
