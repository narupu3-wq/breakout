...
取得UTC: 2026-09-09T05:59:51.031216+00:00
状態: attention_required
実発注0。公開代理価格による仮想結果。候補は別口座で合算しない。

観測時間: 52.71 h / heartbeat経過秒: 40.37373733520508
直近1時間は取得時刻からの半開区間 (開始, 終了]。
イベント累積: {"daily_reset": 24, "no_signal": 3076, "heartbeat": 3073, "decision": 300, "intent": 84, "paper_fill": 84, "close": 80, "collection_error": 2}
イベント直近1h: {"no_signal": 40, "decision": 24, "heartbeat": 58, "close": 4}

| 候補 | 1h決済 | 1h確定USD | 累積決済 | 累積確定USD | 含みUSD | 最大DD USD |
|---|---:|---:|---:|---:|---:|---:|
|mean_reversion-cautious|0|0.0000|13|0.8856|1.7946|7.6680|
|mean_reversion-cautious-stress|0|0.0000|13|-6.1237|1.1562|11.0111|
|mean_reversion-moderate|0|0.0000|13|0.8856|1.7946|7.6680|
|mean_reversion-moderate-stress|0|0.0000|13|-6.1237|1.1562|11.0111|
|trend-cautious|1|-3.1458|7|-13.8645|0.0000|13.8645|
|trend-cautious-stress|1|-3.1409|7|-15.1440|0.0000|15.1440|
|trend-moderate|1|-3.1458|7|-13.8645|0.0000|13.8645|
|trend-moderate-stress|1|-3.1409|7|-15.1440|0.0000|15.1440|

確定は決済取引の手数料・swap込み。含みは退出手数料・追加滑り前。古い/不正/欠損気配は未評価。
- mean_reversion-cautious: BTCUSD side=-1, quote=fresh, quote_ts=1788933549.924247
- mean_reversion-cautious-stress: BTCUSD side=-1, quote=fresh, quote_ts=1788933549.924247
- mean_reversion-moderate: BTCUSD side=-1, quote=fresh, quote_ts=1788933549.924247
- mean_reversion-moderate-stress: BTCUSD side=-1, quote=fresh, quote_ts=1788933549.924247
...
|---|---|---|
|観測間隔|3072 / 61.77 / 62.31 / 123.32|58 / 61.62 / 61.96 / 62.27|
|設定待機時間を超える分|3072 / 1.77 / 2.31 / 63.32|58 / 1.62 / 1.96 / 2.27|
|足確定→条件確認|422 / 33.88 / 61.59 / 78.87|8 / 36.86 / 63.37 / 63.37|
|足確定→シグナル判断|55 / 31.74 / 59.51 / 63.37|5 / 33.58 / 63.37 / 63.37|
