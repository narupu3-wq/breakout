...
取得UTC: 2026-09-08T16:50:47.436322+00:00
状態: attention_required
実発注0。公開代理価格による仮想結果。候補は別口座で合算しない。

観測時間: 39.56 h / heartbeat経過秒: 50.17228889465332
直近1時間は取得時刻からの半開区間 (開始, 終了]。
イベント累積: {"daily_reset": 16, "no_signal": 2300, "heartbeat": 2305, "decision": 244, "intent": 72, "paper_fill": 72, "close": 68, "collection_error": 2}
イベント直近1h: {"heartbeat": 58, "no_signal": 56, "decision": 8}

| 候補 | 1h決済 | 1h確定USD | 累積決済 | 累積確定USD | 含みUSD | 最大DD USD |
|---|---:|---:|---:|---:|---:|---:|
|mean_reversion-cautious|0|0.0000|11|4.2205|-0.6135|7.3058|
|mean_reversion-cautious-stress|0|0.0000|11|-3.6679|-0.6726|10.0661|
|mean_reversion-moderate|0|0.0000|11|4.2205|-0.6135|7.3058|
|mean_reversion-moderate-stress|0|0.0000|11|-3.6679|-0.6726|10.0661|
...
- mean_reversion-cautious: ETHUSD side=-1, quote=fresh, quote_ts=1788886197.264033
- mean_reversion-cautious-stress: ETHUSD side=-1, quote=fresh, quote_ts=1788886197.264033
- mean_reversion-moderate: ETHUSD side=-1, quote=fresh, quote_ts=1788886197.264033
- mean_reversion-moderate-stress: ETHUSD side=-1, quote=fresh, quote_ts=1788886197.264033
...
|---|---|---|
|観測間隔|2304 / 61.81 / 62.40 / 123.32|58 / 61.95 / 63.12 / 63.36|
|設定待機時間を超える分|2304 / 1.81 / 2.40 / 63.32|58 / 1.95 / 3.12 / 3.36|
|足確定→条件確認|318 / 34.16 / 62.00 / 78.87|8 / 36.82 / 53.98 / 53.98|
|足確定→シグナル判断|44 / 32.30 / 56.80 / 59.51|2 / 22.68 / 22.68 / 22.68|
