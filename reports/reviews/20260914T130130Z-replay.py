...
a,b=1788928984.364504,1788929046.043117
stop=78963.54367142859
...
Path(__file__).with_name('20260914T130130Z-replay.json').write_text(json.dumps(result,indent=2)+'\n');print(json.dumps(result,indent=2))
